pub trait ComputePassDescriptor {
    ...
    fn set_frame_bind_groups<'a, 'b>(pass: &mut wgpu::ComputePass<'a>, groups: &'b Self::FrameBindGroups) where 'b: 'a;
...
impl<'a, 'b, Description> ComputePass<'a, Description> where
   ...
   'b: 'a
{
    ...
    pub fn dispatch(
        ...
        inner_pass.dispatch(
            size.0 / workgroup_size.0,
            size.1 / workgroup_size.1,
            size.2 / workgroup_size.2
        );
    }
